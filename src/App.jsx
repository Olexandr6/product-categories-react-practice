...
const products = productsFromServer.map((product) => {
  const category = categoriesFromServer.find(findCategory => (
    findCategory.id === product.categoryId));

  const user = usersFromServer.find(findUser => (
    findUser.id === category.ownerId));
          ...
          <nav className="panel">
            ...
            <p className="panel-tabs has-text-weight-bold">
              <a
                ...
                href="#/"
                onClick={() => handleFilterUserById(0)}
              ...
              <a
                data-cy="FilterUser"
                href="#/"
                onClick={() => handleFilterUserById(1)}
                className={classNames({
                  'is-active': userId === 1,
                })}
              >
              ...
              <a
                data-cy="FilterUser"
                href="#/"
                onClick={() => handleFilterUserById(2)}
                className={classNames({
                  'is-active': userId === 2,
                })}
              >
              ...
              <a
                data-cy="FilterUser"
                href="#/"
                onClick={() => handleFilterUserById(3)}
                className={classNames({
                  'is-active': userId === 3,
                })}
              >
